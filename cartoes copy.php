...
<body>
  ...
  <div class="modal fade view-modal-card modal-view-card" id="" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content modal-content-view-card">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Cartão:</h5>
          <hr class="hr-modal">
  ...
  <div class="container">
    <div class="row content-data-users">
      ...
      <div class="table">
        <h2>Usuários (Ativos: <span id="ativos">99</span> Cancelados: <span id="cancelados">9</span>)</h2>
